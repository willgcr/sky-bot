import { ASPECTS, BODIES, POINTS, ANGLES } from '../core/constants';
import Horoscope from '../core/Horoscope';

export const validateYear = (year) => {
	if (year > 0 && year < 3000) return year;
	else throw new Error (`The year: ${year} - must be an integer > 0 & < 3000 (C.E.)`);
}
