...
const createHoroscope = (
	...
	aspectTypes = ["major", "minor"], customOrbs = {}, language = 'pt') => {
	try {
...
// string houseSystem (placidus) - placidus, koch, campanus, whole-sign, equal-house, regiomontanus, topocentric
// string zodiac (tropical) - tropical, sideral
// array aspectPoints ()
// array aspectWithPoints ()
// array aspectTypes ()
// object customOrbs ()
// string language ()